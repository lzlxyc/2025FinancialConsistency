...
class FaissRetriever(object):
    def __init__(self, model_path, data):
        self.embeddings = HuggingFaceEmbeddings(
            ...
            encode_kwargs={"normalize_embeddings": True}  # Added for better performance
        )
        docs = []
...
if __name__ == "__main__":
    # base = ""
    model_name="D:/LZL/workspace/ModelHub/bge-large-zh-v1.5" #text2vec-large-chinese
    data = '''
    ...
    faissretriever = FaissRetriever(model_name, data.split('\n'))
    # bm25 = BM25(data)
    faiss_ans = faissretriever.GetTopK("根取出与责任免除相关的信息", 2)
    print(faiss_ans)